      ...
      >
        <div className="mx-auto w-full max-w-4xl">
          ...
          <ul className="mt-3 list-disc space-y-2 pl-6 text-text-secondary">
            <li>You use <strong>multiple AI agents</strong> with the same robot (e.g. OpenClaw on desktop + Codex CLI in the terminal + Claude Code on your phone via Dispatch). Each agent sees what the others learned.</li>
