...
export default function Memory() {
      ...
      >
        <div className="mx-auto w-full max-w-4xl">
          ...
          <ul className="mt-3 list-disc space-y-2 pl-6 text-text-secondary">
            <li>You use <strong>multiple AI agents</strong> with the same robot (e.g. OpenClaw on desktop + Codex CLI in the terminal + Hermes Agent for messaging + Claude Code on your phone via Dispatch). Each agent sees what the others learned.</li>
        ...
        <ScrollArrow nextId="memory-backends" label="See memory backends" />
      </section>

      {/* Panel 2: Backends + Enable */}
      <section
        id="memory-backends"
        className="panel relative flex flex-col justify-center border-t border-[var(--border-subtle)] px-6 py-20"
      >
        <div className="mx-auto w-full max-w-4xl">
          <h2 className="font-display text-2xl font-semibold text-text-primary">
            ⟩ Memory &mdash; Backends &amp; Enable
          </h2>

          <h3 className="mt-6 font-display text-lg font-medium text-text-primary">Backends</h3>
          ...
          <h3 className="mt-8 font-display text-lg font-medium text-text-primary">Enable it</h3>
  ...
  "memory": {
    ...
    "backend": "local"
        ...
        <ScrollArrow nextId="packages" label="Continue to Packages" />
      </section>
    </>
  )
}
