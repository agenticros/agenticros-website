...
const packages = [
  ...
  { name: '@agenticros-skills/find', desc: <>Find Object skill: YOLOv8 visual search — rotate in place and stop when a target (any of 80 COCO classes) is detected. Install: <code className="rounded bg-bg-elevated px-1.5 py-0.5 font-mono text-sm text-coral-bright">agenticros skills install @agenticros-skills/find</code> (<a href="https://skills.agenticros.com/chrismatthieu/find" className="text-cyan-bright hover:underline" target="_blank" rel="noopener noreferrer">marketplace</a>).</> },
  { name: '@agenticros-skills/followme', desc: <>Follow Me skill: depth-based (and optional Ollama) person following. Install: <code className="rounded bg-bg-elevated px-1.5 py-0.5 font-mono text-sm text-coral-bright">agenticros skills install @agenticros-skills/followme</code> (<a href="https://skills.agenticros.com/chrismatthieu/followme" className="text-cyan-bright hover:underline" target="_blank" rel="noopener noreferrer">marketplace</a>).</> },
  { name: '@agenticros-skills/navigate-to', desc: <>Marketplace seed: Nav2 <code className="rounded bg-bg-elevated px-1.5 py-0.5 font-mono text-sm text-coral-bright">navigate_to</code> (<a href="https://github.com/agenticros/agenticros-skill-navigate-to" className="text-cyan-bright hover:underline" target="_blank" rel="noopener noreferrer">GitHub</a>).</> },
  { name: '@agenticros-skills/detect-humans', desc: <>Marketplace seed: <code className="rounded bg-bg-elevated px-1.5 py-0.5 font-mono text-sm text-coral-bright">detect_humans</code> vision topic subscribe (<a href="https://github.com/agenticros/agenticros-skill-detect-humans" className="text-cyan-bright hover:underline" target="_blank" rel="noopener noreferrer">GitHub</a>).</> },
  { name: '@agenticros-skills/start-slam', desc: <>Marketplace seed: RTAB-Map <code className="rounded bg-bg-elevated px-1.5 py-0.5 font-mono text-sm text-coral-bright">start_slam</code> / stop / save (<a href="https://github.com/agenticros/agenticros-skill-start-slam" className="text-cyan-bright hover:underline" target="_blank" rel="noopener noreferrer">GitHub</a>).</> },
  { name: '@agenticros-skills/follow-me-ros', desc: <>Marketplace seed: on-robot follow_me services (<a href="https://github.com/agenticros/agenticros-skill-follow-me-ros" className="text-cyan-bright hover:underline" target="_blank" rel="noopener noreferrer">GitHub</a>).</> },
