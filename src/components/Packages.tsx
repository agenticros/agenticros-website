...
const packages = [
  ...
  { name: 'examples/navigate-to', desc: <>Seed skill: wrap Nav2 <code className="rounded bg-bg-elevated px-1.5 py-0.5 font-mono text-sm text-coral-bright">NavigateToPose</code> as an <code className="rounded bg-bg-elevated px-1.5 py-0.5 font-mono text-sm text-coral-bright">external_ros_node</code> capability. Template for calling existing ROS nodes by name (<a href="https://github.com/agenticros/agenticros/tree/main/examples/navigate-to" className="text-cyan-bright hover:underline" target="_blank" rel="noopener noreferrer">repo example</a>).</> },
