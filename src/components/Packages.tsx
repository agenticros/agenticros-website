const packages = [
  ...
  { name: '@agenticros/claude-code', desc: <>Claude Code CLI <a href="https://modelcontextprotocol.io/docs/getting-started/intro" className="text-cyan-bright hover:underline" target="_blank" rel="noopener noreferrer">MCP</a> server: ROS2 tools in the terminal (list topics, publish, camera, services, actions); register with claude mcp add</> },
