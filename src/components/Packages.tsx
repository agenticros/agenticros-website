...
const packages = [
  ...
  { name: 'agenticros_sim', desc: <>ROS 2 package: Gazebo Harmonic simulation assets &mdash; 2-wheel <strong>AMR</strong> (+ optional Nav2 via <code className="rounded bg-bg-elevated px-1.5 py-0.5 font-mono text-sm text-coral-bright">sim_amr_nav2</code>, or Shadow AMR live RealSense overlay via <code className="rounded bg-bg-elevated px-1.5 py-0.5 font-mono text-sm text-coral-bright">--real-camera</code>), 6-DOF <strong>arm</strong>, indoor world, RViz configs, and <code className="rounded bg-bg-elevated px-1.5 py-0.5 font-mono text-sm text-coral-bright">ros_gz_bridge</code> YAMLs that match real-robot topic names.</> },
