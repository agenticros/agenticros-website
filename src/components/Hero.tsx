  ...
  return (
    <section className="relative flex min-h-[85vh] flex-col items-center justify-center px-6 py-20 text-center">
      ...
      <p className="mt-3 text-text-muted">
        ...
        , <a href="https://claude.com/product/claude-code" className="text-cyan-bright hover:underline" target="_blank" rel="noopener noreferrer">Claude Code</a>, MCP, etc) to control ROS2 robots!
      </p>
      <a
        href="#quick-start"
