    ...
    <section id="quick-start" className="scroll-mt-20 border-t border-[var(--border-subtle)] px-6 py-16">
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mt-8 space-y-6">
          ...
          <div>
            <h3 className="text-lg font-medium text-text-primary">2. Pick what you want from the interactive menu</h3>
            <pre
...
❯ Launch with simulation
  ...
  Tail logs`}</code>
            ...
            <ul className="mt-3 list-disc space-y-2 pl-6 text-text-secondary">
              ...
              <li><strong>Manage skills</strong> &mdash; discover, register, and remove AgenticROS <a href="#skills" className="text-cyan-bright hover:underline">skills</a> (Find Object, Follow Me, your own). The CLI scans for clones, edits <code className="rounded bg-bg-elevated px-1.5 py-0.5 font-mono text-sm">~/.openclaw/openclaw.json</code>, and refreshes the OpenClaw <code className="rounded bg-bg-elevated px-1.5 py-0.5 font-mono text-sm">contracts.tools</code> allowlist for you.</li>
...
agenticros down                 # stop everything we started`}</code>
          ...
          <div>
            ...
            <ul className="mt-2 list-disc space-y-2 pl-6 text-text-secondary">
              <li>
                <a href="https://openclaw.ai/" className="text-cyan-bright hover:underline" target="_blank" rel="noopener noreferrer">OpenClaw</a>: the CLI's first-time setup installs and configures the plugin for you.
              </li>
              <li>
                <a href="https://www.nvidia.com/en-us/ai/nemoclaw" className="text-cyan-bright hover:underline" target="_blank" rel="noopener noreferrer">NemoClaw</a>: same plugin in a sandbox &mdash; see the main repo for setup.
              </li>
              <li>
              ...
              <li>
                <a href="https://claude.com/download" className="text-cyan-bright hover:underline" target="_blank" rel="noopener noreferrer">Claude Desktop</a> &amp; <a href="https://claude.com/" className="text-cyan-bright hover:underline" target="_blank" rel="noopener noreferrer">Dispatch</a> (iOS, paired to your Mac): add the same MCP server to <code className="rounded bg-bg-elevated px-1.5 py-0.5 font-mono text-coral-bright">~/Library/Application Support/Claude/claude_desktop_config.json</code> with an absolute path to <code className="rounded bg-bg-elevated px-1.5 py-0.5 font-mono text-coral-bright">dist/index.js</code>, then fully quit and restart Claude. Details:{' '}
                <a href="https://github.com/agenticros/agenticros/blob/main/packages/agenticros-claude-code/README.md" className="text-cyan-bright hover:underline" target="_blank" rel="noopener noreferrer">Claude adapter README</a>.
              </li>
              <li>
                <a href="https://ai.google.dev/gemini-api/docs" className="text-cyan-bright hover:underline" target="_blank" rel="noopener noreferrer">Google Gemini</a>: standalone CLI &mdash; same tools, no MCP. Set <code className="rounded bg-bg-elevated px-1.5 py-0.5 font-mono text-coral-bright">GEMINI_API_KEY</code> and run.
              </li>
            </ul>
          </div>
        </div>
        ...
        <div
          className="mt-10 rounded-xl border border-[var(--border-subtle)] p-6"
...
./agenticros                    # repo-local CLI shim, same menu as \`npx agenticros\``}</code>
          ...
          <p className="mt-3 text-sm text-text-muted">
            See{' '}
            <a href="https://github.com/agenticros/agenticros/blob/main/docs/robot-setup.md" className="text-cyan-bright hover:underline" target="_blank" rel="noopener noreferrer">Robot Setup</a>
            ,{' '}
            <a href="https://github.com/agenticros/agenticros/tree/main/docs" className="text-cyan-bright hover:underline" target="_blank" rel="noopener noreferrer">docs/</a>
            , and the{' '}
            <a href="https://github.com/agenticros/agenticros/blob/main/packages/agenticros-cli/README.md" className="text-cyan-bright hover:underline" target="_blank" rel="noopener noreferrer">agenticros-cli README</a>
            {' '}for transports, namespaces, and Docker workflows.
          </p>
        </div>
      </div>
    </section>
