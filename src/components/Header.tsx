      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            className="hidden items-center gap-1 text-sm font-medium text-accent-bright transition hover:opacity-80 md:inline-flex"
            aria-label="Browse the AgenticROS Skills Marketplace"
          >
            Skills Store
            <svg
              viewBox="0 0 24 24"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 rounded-lg bg-cyan-bright px-3 py-2 text-sm font-medium text-white transition hover:bg-cyan-mid"
