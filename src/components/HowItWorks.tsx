export default function HowItWorks() {
  const steps = [
    ...
    'Your AI agent (OpenClaw or another supported agent)',
    ...
    <section id="how-it-works" className="scroll-mt-20 border-t border-[var(--border-subtle)] px-6 py-16">
      <div className="mx-auto max-w-4xl">
        ...
        <p className="mt-4 text-text-secondary">
          AgenticROS works with <strong>multiple AI agents</strong>, including OpenClaw. A user sends a natural language message through any messaging app. Your chosen AI agent receives it and uses ROS2 tools registered by the AgenticROS plugin. The agent translates intent into ROS2 operations (topic publish, service call, action goal). The robot acts, and the agent streams feedback back to the chat.
        </p>
