...
const features = [
  ...
  },
  {
    ...
    description: (
      <>
        Optional skill packages add tools and behaviors (e.g. <a href="https://skills.agenticros.com/s/find" className="text-cyan-bright hover:underline" target="_blank" rel="noopener noreferrer">Find Object</a>, <a href="https://skills.agenticros.com/s/followme" className="text-cyan-bright hover:underline" target="_blank" rel="noopener noreferrer">Follow Me</a>). Browse the <a href="https://skills.agenticros.com" className="text-cyan-bright hover:underline" target="_blank" rel="noopener noreferrer">Skills Marketplace</a>, install with one command (<code className="rounded bg-bg-elevated px-1 py-0.5 font-mono text-xs text-coral-bright">agenticros skills install &lt;slug&gt;</code>), or sign in with GitHub to submit your own.
      </>
    ),
  },
  {
